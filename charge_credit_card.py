...
def charge_credit_card(amount):
    ...
    customerAddress.company = "0"
    customerAddress.address = "0"
    customerAddress.city = "P0 0"
    customerAddress.state = "SP"
    customerAddress.zip = "000"
    customerAddress.country = "BRA"
    ...
    line_item_1.unitPrice = "99912.95"
    ...
    entrega.firstName = "Ellen"
    entrega.lastName = "Johnson"
    entrega.company = "Souveniropolis"
    entrega.address = "14 Main Street"
    entrega.city = "Peca Springs"
    entrega.state = "SP"
    entrega.zip = "000"
    entrega.country = "BRA"
